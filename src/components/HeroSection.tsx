...
const HeroSection = () => {
  return (
    <section id="home" className="relative min-h-screen flex items-center overflow-hidden pt-20">
      ...
      <div className="absolute top-1/3 right-[5%] w-80 h-80 border border-primary/20 rounded-full spin-slow opacity-20" style={{ animationDirection: "reverse" }} />
          ...
          <div>
            ...
            >
              ...
              <span className="text-gradient-coral relative">
                ...
                <svg className="absolute -bottom-2 left-0 w-full" viewBox="0 0 200 12" fill="none">
                  <path d="M2 8C50 2 150 2 198 8" stroke="hsl(12 90% 62%)" strokeWidth="3" strokeLinecap="round" />
                </svg>
              </span>
            </motion.h1>
            ...
            >
              <div className="flex -space-x-3">
                {["bg-primary", "bg-ocean", "bg-lime", "bg-secondary"].map((color, i) => (
                  <div key={i} className={`w-10 h-10 rounded-full ${color} border-2 border-card flex items-center justify-center text-xs font-bold text-primary-foreground`}>
                    {["JD", "AK", "SR", "MN"][i]}
                  </div>
                ))}
              </div>
              <div>
                <div className="font-bold text-foreground text-sm">200+ Happy Clients</div>
                <div className="text-muted-foreground text-xs">⭐⭐⭐⭐⭐ 4.9/5 rating</div>
              </div>
            </motion.div>
          </div>
          ...
          >
            <div className="relative">
              ...
              <div className="blob-shape overflow-hidden w-full aspect-square">
                <img src={heroBg} alt="Vibrant 3D shapes representing creative digital marketing" className="w-full h-full object-cover" />
              </div>
              ...
              >
                <div className="w-10 h-10 rounded-2xl bg-peach flex items-center justify-center text-lg">📈</div>
                <div>
              ...
              >
                <div className="w-10 h-10 rounded-2xl bg-sky flex items-center justify-center text-lg">🎯</div>
                <div>
